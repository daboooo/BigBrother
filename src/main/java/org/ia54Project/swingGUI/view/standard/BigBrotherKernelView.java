...
public class BigBrotherKernelView extends BigBrotherDetailView {
	...
	public BigBrotherKernelView() {
		initialize();
	}
	
	public BigBrotherKernelView(KernelModel model) {
		initialize();
		setModel(model);
	}
	
	public void setModel(KernelModel model) {
		...
		tableValues.getModel().setValueAt(model.getKernelAddress(), 1, 0);
	...
	private void initialize() {
		...
		JLabel lblRoleDetails = new JLabel("Kernel Details");
